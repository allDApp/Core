...
$(function() {
	...
	document.getElementById('PLAYERSOCS').innerHTML="你的最高成绩:关卡" + uid + '</br><div  role="presentation" href="javascript:void(0)" style="text-align:center"><a id="upnew" href="javascript:void(0)" class="title">点击上传成绩至链上</a></div>';
	if (uid==null){document.getElementById('PLAYERSOCS').innerHTML="还没有玩过这个游戏</br> <a href='./index.html'>点我玩游戏</a>"}
$("#getnew").click(function() {
	
	var to = "n1ewdvZacUiuZoWhXhrsPMyux7oqQfC3LMV";
	var value = "0";
...
$("#upnew").click(function() {
	...
	var to = "n1ewdvZacUiuZoWhXhrsPMyux7oqQfC3LMV";
	var value = "0";
	var callFunction = "Core";
	var callArgs = "[\"" + "完成关卡:" + uid +"\"]";
